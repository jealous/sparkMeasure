...
class UtilsTest extends FlatSpec with Matchers {
  ...
  val stageVals0 = StageVals(jobId = 1, stageId = 2, name = "stageVal",
    _StageMetrics(submissionTime = 10, completionTime = 11, stageDuration = 12, numTasks = 13),
    _TaskMetrics(executorRunTime = 14, executorCpuTime = 15,
    ...
    _ShuffleMetrics(shuffleFetchWaitTime = 40, shuffleTotalBytesRead = 41, shuffleTotalBlocksFetched = 42,
